...
function setResourceIdUriParam(param) {
    this.selectedPolicy._uriParam('resource', param);
    return this;
}

function setResourceOwnerIdUriParam(param) {
    this.selectedPolicy._uriParam('resourceOwner', param);
    return this;
}

function setResourceParentIdUriParam(param) {
...
Policies.prototype.setResourceId = setResourceIdUriParam;
Policies.prototype.setResourceOwnerId = setResourceOwnerIdUriParam;
Policies.prototype.setResourceParentId = setResourceParentIdUriParam;
