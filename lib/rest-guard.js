...
function getOwner(modelName,  model, owner, callback) {
    __log(_modelOwnersFields, _modelParentingFields);
    modelService.getOwner(modelName, model, owner, _modelOwnersFields, _modelParentingFields,
        function (err, ids) {
            __log('OWNERS', ids);
...
PolicyResult.prototype.getResourceOwner = function (id, req, callback) {
};
...
function getResourceOwnerMethod(policy, uriParams) {
    ...
    return function (id, req, callback) {
        ...
        getOwner(policy.model, model, owner, callback);
