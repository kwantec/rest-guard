...
/**
 *
 * @param modelOwnersFields, a Object with properties with 'Model.parentField': 'ParentModel' format.
...
function createExpressInterceptor(apiUriRoot) {
    ...
    return function (methodName) {
        ...
        if (methodName == 'route') { // if is route method call
            ...
            //return [function(req, res, next){ res.json({nopasa:'nada'});}];
        }
    };
}
...
function findPolicyByHttpCall(uri, method) {
    ...
    if (policyContent) {
        ...
        AddGetMethod(policy, params, 'resource');
...
RestGuard.prototype.grantRoles = function () {
    rolesService.grantRoles.apply(rolesService, arguments);
    return this;
};

RestGuard.prototype.revokeRoles = function () {
    rolesService.revokeRoles.apply(rolesService, arguments);
    return this;
};

RestGuard.prototype.grantPermission = function () {
    permissionService.save.apply(permissionService, arguments);
    return this;
};

RestGuard.prototype.revokePermission = function () {
    permissionService.remove.apply(permissionService, arguments);
    return this;
};

RestGuard.prototype.userCredentialsFn = function () {
    permissionService.userCredentialsFn.apply(permissionService, arguments);
    return this;
}

RestGuard.prototype.configureStorage = function () {
    permissionService.configureStorage.apply(permissionService, arguments);
    return this;
};

RestGuard.prototype.middleware = function () {
    return permissionService.evaluateEndpoint.apply(permissionService, arguments);
};

RestGuard.prototype.evaluate = function () {
